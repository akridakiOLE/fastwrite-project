...
const MUTATIONS = [
  ...
  /* ⚠ ΑΓΚΥΡΑ ΜΟΝΟ ΣΤΗ ΓΡΑΜΜΗ ΤΟΥ HOOK — ΟΧΙ στο κλείσιμο της show().
     Μετρήθηκε 20/9/2026: η v75 πρόσθεσε δεύτερο hook (accWarn) ακριβώς από
     κάτω, ο παλιός στόχος «γραμμή + \n  }» έπαψε να υπάρχει, και η απόδειξη
     σταμάτησε το deploy χωρίς να υπάρχει πραγματικό σφάλμα. Ίδια οικογένεια
     με τον δείκτη που είχε μέσα του αριθμό έκδοσης. */

...
(function () {
  ...
  /* ══ v62 · Brief Ε §4 — ΕΡΩΤΗΣΕΙΣ & ΑΠΑΝΤΗΣΕΙΣ ══════════════════════
     16 από τα 17 κείμενα (1-16 + 12β) που ενέκρινε ο Stavros 11/9/2026. Το #14 (iPhone)
     ΔΕΝ μπαίνει μέχρι να γίνει η μία δοκιμή σε πραγματικό iPhone, στο τέλος
     (απόφαση 16/9). Το #12 ξαναγράφτηκε 16/9 για την αναστολή 72 ωρών.
  ...
  var FAQ = [
    ...
    { h: 'Εγκατάσταση' },
    { q: 'Πώς το βάζω στην αρχική οθόνη σαν εφαρμογή;',
      a: 'Στο Chrome, πάτα το μενού (⋮) και διάλεξε <b>«Εγκατάσταση εφαρμογής»</b>, όχι «Προσθήκη στην αρχική οθόνη». Η εγκατάσταση ανοίγει σαν κανονική εφαρμογή, χωρίς τη γραμμή διευθύνσεων.' },

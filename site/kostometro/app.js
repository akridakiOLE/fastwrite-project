...
(function () {
  ...
  var FAQ = [
    ...
    { id: 'install-ios',
      ...
      a: 'Άνοιξε τη σελίδα στο <b>Safari</b> — όχι σε Chrome, γιατί μόνο το Safari το κάνει σωστά στο iPhone.<br><br>Πάτα το κουμπί <b>Κοινοποίηση</b> (το τετράγωνο με το βέλος προς τα πάνω, στο κάτω μέρος της οθόνης), κύλησε προς τα κάτω και διάλεξε <b>«Προσθήκη στην οθόνη Αφετηρίας»</b>, και μετά <b>«Προσθήκη»</b>.<br><br>Μετά κλείσε το Safari και άνοιξε την εφαρμογή <b>από το εικονίδιο</b>: ανοίγει σε ολόκληρη την οθόνη, χωρίς τη γραμμή διευθύνσεων. Το iPhone δεν έχει «Εγκατάσταση εφαρμογής» όπως το Android — αυτός είναι ο δρόμος.' },

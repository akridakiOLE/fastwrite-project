...
const I18N = {
  ...
  translations: {
    el: {
      ...
      sidebar_logout_hint: 'Αποσύνδεση από τον λογαριασμό σας',
      sidebar_billing: 'Χρεώσεις',
      sidebar_upgrade: 'Αναβάθμιση',
      sidebar_documents_used: 'Έγγραφα',
      legal_link: 'Όροι & Απόρρητο',

      // ── Billing & Pricing ──
      page_pricing: 'Πλάνα Τιμολόγησης',
      page_billing: 'Χρεώσεις',
      billing_current_plan: 'Τρέχον Πλάνο',
      billing_per_month: '/ μήνα',
      billing_upgrade: 'Αναβάθμιση Πλάνου',
      billing_view_plans: 'Πλάνα',
      billing_manage: 'Διαχείριση Πληρωμών',
      billing_usage: 'Χρήση Τρέχουσας Περιόδου',
      billing_documents: 'Έγγραφα',
      billing_pages: 'Σελίδες',
      billing_invoices: 'Τιμολόγια',
      billing_no_invoices: 'Δεν υπάρχουν τιμολόγια ακόμα.',
      billing_active: 'Ενεργό',
      billing_renews: 'Ανανεώνεται:',
      billing_cancels_at_end: 'Ακυρώνεται στο τέλος της περιόδου',
      billing_success: 'Η συνδρομή ενεργοποιήθηκε!',
      billing_canceled: 'Η πληρωμή ακυρώθηκε.',
      pricing_free: 'Δωρεάν',
      pricing_custom: 'Κατόπιν συνεννόησης',
      pricing_unlimited: 'Απεριόριστα',
      pricing_unlimited_templates: 'Απεριόριστες ετικέτες',
      pricing_current: 'Τρέχον πλάνο',
      pricing_contact: 'Επικοινωνία',
      pricing_subscribe: 'Εγγραφή',
      limit_modal_title: 'Όριο Πλάνου',
      limit_modal_message: 'Έχετε φτάσει το όριο εγγράφων του πλάνου σας. Αναβαθμίστε για περισσότερα.',
      limit_modal_upgrade: 'Αναβάθμιση',
      limit_modal_close: 'Κλείσιμο',
      usage_warning_text: 'Έχετε χρησιμοποιήσει {used} από {limit} έγγραφα. Αναβαθμίστε για περισσότερα.',
      ...
      // ── Approval / Tour i18n leaks ──
      ap_docs_dd_hint: 'Εμφάνιση λίστας εγγράφων προς έγκριση',
      ap_docs_btn: 'Έγγραφα',
      ap_tour_toggle_hint: 'Καθοδηγούμενη Έγκριση — δείχνει ένα πεδίο τη φορά μεγάλο πάνω στο τιμολόγιο',
      ap_sidebar_toggle_title: 'Εμφάνιση/Απόκρυψη μενού',
      ap_zoom_in_title: 'Μεγέθυνση (Ctrl + scroll up)',
      ap_zoom_reset_title: 'Επαναφορά (διπλό κλικ)',
      ap_zoom_out_title: 'Σμίκρυνση (Ctrl + scroll down)',
      ap_tour_row: 'Γραμμή',
      ap_tour_exit_title: 'Έξοδος (Esc)',
      ap_tour_row_prev: '↑ Προηγ.',
      ap_tour_row_next: 'Επόμ. ↓',
      ap_tour_approve: '✓ Έγκριση Τιμολογίου',
      ap_tour_field: 'Πεδίο',
      ap_tour_prev: '← Προηγ.',
      ap_tour_skip_title: 'Παράκαμψη στις γραμμές (PageDown)',
      ap_tour_skip: '⏭ Γραμμές',
      ap_tour_next: 'Επόμ. →',
      ap_scalar_toggle_hide: '▲ Απόκρυψη',
      tour_enabled: 'Ενεργό',
      tour_disabled: 'Ανενεργό',
      tour_no_positions: 'Δεν υπάρχουν θέσεις πεδίων για αυτό το έγγραφο. Ξαναεξαγάγετε για να δημιουργηθούν.',
      tour_no_known_positions: 'Δεν βρέθηκαν εξαγόμενα πεδία με γνωστές θέσεις.',
      tour_plus_lineitems: '(+ γραμμές)',
      tour_to_lineitems: 'Γραμμές →',
      tour_done: '✓ Τέλος',
      tour_next: 'Επόμ. →',
      tour_cell_from_pdf: 'Από PDF — δεν υπάρχει στο template',
      tour_complete_approve: 'Το tour ολοκληρώθηκε. Πατήστε ✓✓ Έγκριση Τιμολογίου για ολοκλήρωση.',
      settings_tour_card_title: '🎯 Εμφάνιση Σελίδας Έγκρισης',
      settings_tour_label: 'Καθοδηγούμενη Έγκριση (Tour Mode)',
      settings_tour_desc: 'Όταν είναι ενεργό, η σελίδα Έγκρισης ανοίγει αυτόματα σε λειτουργία Tour Mode (ένα πεδίο τη φορά με highlight πάνω στο τιμολόγιο).',
      upload_schema_hint: 'ℹ Χρησιμοποιείται μόνο αν το Auto Match δεν βρει ετικέτα',

      // ── Xero Integration ──
      xero_card_title: '🔗 Σύνδεση με Xero',
      xero_connect_btn: 'Σύνδεση με Xero',
      xero_disconnect_btn: 'Αποσύνδεση',
      xero_card_note: 'Push εξαγόμενων τιμολογίων ως DRAFT Bills στο Xero',
      xero_connected_to: 'Συνδεδεμένος στο',
      xero_not_connected: 'Μη συνδεδεμένος',
      xero_unavailable: 'Μη διαθέσιμο',
      xero_awaiting_consent: 'Περιμένει consent στον browser...',
      xero_opening_browser: 'Ανοίγει browser για consent...',
      xero_error: 'σφάλμα',
      xero_account_apply_note: 'Ο επιλεγμένος account code εφαρμόζεται σε όλα τα line items',
      xero_cancel: 'Άκυρο',
      xero_push_draft_note: 'Το Bill δημιουργείται σε κατάσταση <strong>DRAFT</strong> — εσύ το κάνεις AUTHORISE μέσα στο Xero.',
      xero_account_select_placeholder: '— Επιλογή —',
      xero_accounts_loading: 'Φόρτωση accounts...',
      xero_no_accounts: 'Δεν βρέθηκαν διαθέσιμοι λογαριασμοί',
    ...
    en: {
      ...
      billing_cancels_at_end: 'Cancels at end of period',
      billing_success: 'Subscription activated!',
      billing_canceled: 'Payment canceled.',
      pricing_free: 'Free',
      pricing_custom: 'Custom',
      pricing_unlimited: 'Unlimited',
      pricing_unlimited_templates: 'Unlimited templates',
      pricing_current: 'Current plan',
      pricing_contact: 'Contact Us',
      pricing_subscribe: 'Subscribe',
      limit_modal_title: 'Plan Limit Reached',
      limit_modal_message: 'You have reached your plan document limit. Upgrade for more capacity.',
      limit_modal_upgrade: 'Upgrade',
      limit_modal_close: 'Close',
      usage_warning_text: 'You have used {used} of {limit} documents. Upgrade for more capacity.',
      ...
      // ── Approval / Tour i18n leaks ──
      ap_docs_dd_hint: 'Show list of documents to approve',
      ap_docs_btn: 'Documents',
      ap_tour_toggle_hint: 'Guided Approval — shows one field at a time, enlarged over the invoice',
      ap_sidebar_toggle_title: 'Show/Hide menu',
      ap_zoom_in_title: 'Zoom in (Ctrl + scroll up)',
      ap_zoom_reset_title: 'Reset (double-click)',
      ap_zoom_out_title: 'Zoom out (Ctrl + scroll down)',
      ap_tour_row: 'Row',
      ap_tour_exit_title: 'Exit (Esc)',
      ap_tour_row_prev: '↑ Prev',
      ap_tour_row_next: 'Next ↓',
      ap_tour_approve: '✓ Approve Invoice',
      ap_tour_field: 'Field',
      ap_tour_prev: '← Prev',
      ap_tour_skip_title: 'Skip to line items (PageDown)',
      ap_tour_skip: '⏭ Line Items',
      ap_tour_next: 'Next →',
      ap_scalar_toggle_hide: '▲ Hide',
      tour_enabled: 'Enabled',
      tour_disabled: 'Disabled',
      tour_no_positions: 'No field positions exist for this document. Re-extract to generate them.',
      tour_no_known_positions: 'No extracted fields with known positions were found.',
      tour_plus_lineitems: '(+ line items)',
      tour_to_lineitems: 'Line Items →',
      tour_done: '✓ Done',
      tour_next: 'Next →',
      tour_cell_from_pdf: 'From PDF — not in template',
      tour_complete_approve: 'The tour is complete. Press ✓✓ Approve Invoice to finish.',
      settings_tour_card_title: '🎯 Approval Page Display',
      settings_tour_label: 'Guided Approval (Tour Mode)',
      settings_tour_desc: 'When enabled, the Approval page opens automatically in Tour Mode (one field at a time, highlighted on the invoice).',
      upload_schema_hint: 'ℹ Used only if Auto Match does not find a label',

      // ── Xero Integration ──
      xero_card_title: '🔗 Connect to Xero',
      xero_connect_btn: 'Connect to Xero',
      xero_disconnect_btn: 'Disconnect',
      xero_card_note: 'Push extracted invoices to Xero as DRAFT Bills',
      xero_connected_to: 'Connected to',
      xero_not_connected: 'Not connected',
      xero_unavailable: 'Unavailable',
      xero_awaiting_consent: 'Waiting for consent in the browser...',
      xero_opening_browser: 'Opening browser for consent...',
      xero_error: 'error',
      xero_account_apply_note: 'The selected account code applies to all line items',
      xero_cancel: 'Cancel',
      xero_push_draft_note: 'The Bill is created as <strong>DRAFT</strong> — you authorise it inside Xero.',
      xero_account_select_placeholder: '— Select —',
      xero_accounts_loading: 'Loading accounts...',
      xero_no_accounts: 'No accounts available',

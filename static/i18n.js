...
const I18N = {
  ...
  translations: {
    el: {
      ...
      demo_key_desc: 'Δεν έχεις ακόμα Gemini API key; Δοκίμασε το FastWrite ΑΜΕΣΩΣ με το δωρεάν demo key μας (όριο 100 έγγραφα). Μετά μπορείς να βάλεις το δικό σου κλειδί όποτε θέλεις.',
      demo_key_btn: '🎁 Δοκίμασε με demo key',
      demo_key_ok: 'Το demo key ενεργοποιήθηκε! Μπορείς να επεξεργαστείς έως {cap} έγγραφα.',
    ...
    en: {
      ...
      demo_key_desc: 'No Gemini API key yet? Try FastWrite RIGHT NOW with our free demo key (100-document limit). You can switch to your own key anytime.',
      demo_key_btn: '🎁 Try with demo key',
      demo_key_ok: 'Demo key activated! You can process up to {cap} documents.',

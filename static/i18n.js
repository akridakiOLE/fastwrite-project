...
const I18N = {
  ...
  translations: {
    el: {
      ...
      // ── In-app Feedback ──
      sidebar_feedback: 'Σχόλια & Ιδέες',
      fb_title: 'Σχόλια & Ιδέες',
      fb_subtitle: 'Πες μου τι δουλεύει, τι όχι, τι λείπει. Κάθε μήνυμα διαβάζεται.',
      fb_category: 'Κατηγορία',
      fb_cat_bug: 'Πρόβλημα / Bug',
      fb_cat_idea: 'Ιδέα / Πρόταση',
      fb_cat_other: 'Άλλο',
      fb_message: 'Μήνυμα',
      fb_image: 'Στιγμιότυπο οθόνης (προαιρετικό, PNG/JPG έως 2MB)',
      fb_privacy_note: '⚠ Μην επισυνάπτεις εικόνες με πραγματικά παραστατικά ή προσωπικά δεδομένα.',
      fb_cancel: 'Άκυρο',
      fb_send: 'Αποστολή',
      fb_sent: 'Το μήνυμα στάλθηκε — ευχαριστώ!',
      fb_err_message_required: 'Γράψε ένα μήνυμα πρώτα.',
      fb_err_image_type: 'Μόνο PNG ή JPG εικόνες.',
      fb_err_image_size: 'Η εικόνα ξεπερνά τα 2MB.',
      fb_err_image_read: 'Αποτυχία ανάγνωσης της εικόνας.',
      fb_err_send_failed: 'Αποτυχία αποστολής. Δοκίμασε ξανά.',

      // ── Admin: Desktop Testers & Feedback ──
      admin_installs_title: 'Desktop Testers — Εγκαταστάσεις & Χρήση',
      admin_installs_note: 'Δεδομένα από τα telemetry pings της desktop εφαρμογής (μόνο πλήθη — ποτέ περιεχόμενο εγγράφων).',
      admin_installs_empty: 'Καμία εγκατάσταση ακόμα.',
      admin_col_user: 'Χρήστης',
      admin_col_registered: 'Εγγραφή',
      admin_col_demo_docs: 'Demo έγγραφα',
      admin_col_docs_total: 'Σύνολο εγγράφων',
      admin_col_last_seen: 'Τελευταία δραστηριότητα',
      admin_feedback_title: 'Feedback από την εφαρμογή',
      admin_feedback_empty: 'Κανένα feedback ακόμα.',
      admin_feedback_image: 'Εικόνα ↗',
      ...
      // ── i18n leak fixes ──
      server_connecting: 'Σύνδεση...',
      docs_delete_title: 'Διαγραφή επιλεγμένων',
      le_docs_dd_hint: 'Εμφάνιση λίστας επιλεγμένων εγγράφων για επεξεργασία',
      le_docs_btn: '📄 Έγγραφα',
      le_labels_dd_hint: 'Εμφάνιση υφιστάμενων ετικετών — επιλέξτε ή διαγράψτε',
      le_sidebar_toggle_title: 'Εμφάνιση/Απόκρυψη μενού',
      le_lineitems_hint: 'Προσθήκη πίνακα γραμμών (line items) στην ετικέτα — για τιμολόγια με πολλές γραμμές',
      le_hide_panel_title: 'Κρύψε πίνακα',
      le_label_name: 'Όνομα Ετικέτας',
      le_name_placeholder: 'π.χ. invoice_dei, cosmote_receipt...',
      le_supplier: '🏢 Προμηθευτής / Πωλητής',
      le_supplier_placeholder: 'π.χ. cosmote, ote, κοσμοτε — πολλαπλές με κόμμα',
      le_fields: 'Πεδία (χωρισμένα με κόμμα)',
      le_fields_placeholder: 'π.χ. invoice_number, date, total',
      le_lineitems_cols: '📋 Στήλες Line Items (χωρισμένα με κόμμα)',
      le_lineitems_placeholder: 'π.χ. Description, Quantity, Price',
      le_preview_hint: 'Προβολή δομής ετικέτας πριν την αποθήκευση',
      le_preview_btn: 'Προεπισκόπηση',
      le_preview_title: 'Προεπισκόπηση Ετικέτας',
      le_back_form_hint: 'Επιστροφή στη φόρμα για αλλαγές',
      le_save_hint: 'Αποθήκευση ετικέτας — θα είναι διαθέσιμη για αυτόματη αντιστοίχιση',
      le_save_btn: '💾 Αποθήκευση',
      tb_new_tmpl_title: '+ Δημιουργία Νέου Template',
      tb_name_placeholder: 'π.χ. invoice, receipt',
      tb_addfield_hint: 'Προσθήκη νέου πεδίου εξαγωγής στο template',
      tb_addfield_btn: '+ Προσθήκη Πεδίου',
      tb_save_btn: 'Αποθήκευση Template',
      doc_modal_title: 'Λεπτομέρειες Εγγράφου',
      tmpl_modal_title: 'Νέα Ετικέτα',
      tmpl_label: 'Ετικέτα',
      tmpl_name_placeholder: 'π.χ. invoice_dei, cosmote_receipt...',
      tmpl_supplier: '🏢 Προμηθευτής Πωλητής (λέξεις-κλειδιά προμηθευτή, π.χ. ΔΕΗ, DEI, δεη)',
      tmpl_supplier_placeholder: 'π.χ. cosmote, ote, κοσμοτε — πολλαπλές με κόμμα',
      tmpl_addfield_hint: 'Προσθήκη νέου πεδίου εξαγωγής στην ετικέτα',
      tmpl_addfield_btn: '+ Προσθήκη Πεδίου',
      tmpl_paste_hint: 'Επικόλληση ετικέτας από clipboard',
      tmpl_paste_btn: '📋 Επικόλληση',
      tmpl_save_hint: 'Αποθήκευση ετικέτας — θα είναι διαθέσιμη για αυτόματη αντιστοίχιση εγγράφων',
      tmpl_save_btn: 'Αποθήκευση Template',
      precheck_modal_title: 'Ανάλυση Αρχείου',
      xero_oauth_timeout: 'OAuth timeout — δοκίμασε ξανά',
      xero_connect_success: 'Επιτυχής σύνδεση στο Xero!',
      xero_error_toast: 'Σφάλμα Xero',
      xero_disconnect_confirm: 'Σίγουρα θέλεις να αποσυνδεθείς από το Xero;',
      xero_disconnected: 'Αποσυνδέθηκες από το Xero',
      xero_tenant_changed: 'Active tenant άλλαξε',
      xero_connect_first: 'Πρέπει πρώτα να συνδεθείς στο Xero (Ρυθμίσεις)',
      xero_select_account: 'Επίλεξε account code πρώτα',
      xero_push_failed: 'Push απέτυχε',
      xero_push_success: 'Bill δημιουργήθηκε στο Xero (DRAFT) — άνοιξε με 🔗✓',
      xero_push_network_error: 'Σφάλμα δικτύου στο Push',
      license_invalid: 'Άκυρη άδεια',
      license_error_label: 'License σφάλμα',
      ...
      docs_th_file: 'ΑΡΧΕΙΟ',
      docs_th_labels: 'Ετικέτα',
      docs_th_supplier: 'Όνομα Προμηθευτή',
      docs_th_buyer: 'Όνομα Αγοραστή',
      docs_last_n_label: 'Τελευταία',
      docs_last_n_btn: 'Επιλογή',
      docs_selected_lbl: 'Επιλεγμένα',
      docs_in_list_lbl: 'Στη λίστα',
      docs_th_pct: 'ΠΟΣΟΣΤΟ',
      ...
      js_batch_blocked_msg: 'Το Batch δεν μπορεί να τρέξει: {n} από τα επιλεγμένα έχουν ΗΔΗ επεξεργαστεί. Αφαίρεσέ τα από την επιλογή και ξαναπροσπάθησε.',
      js_batch_max_msg: 'Ο μέγιστος αριθμός τιμολογίων ανά Batch είναι {max}. Έχεις επιλέξει {n}. Μείωσε την επιλογή και ξαναπροσπάθησε.',
      js_enter_valid_number: 'Γράψε έναν έγκυρο αριθμό',
      tpl_del_selected: 'Διαγραφή επιλεγμένων',
      tpl_del_all: 'Διαγραφή ΟΛΩΝ',
      tpl_select_all: 'Επιλογή ΟΛΩΝ',
      tpl_del_all_confirm: 'Σίγουρα να διαγραφούν ΟΛΕΣ οι {n} ετικέτες; Δεν αναιρείται.',
      ...
      js_limit_docs: 'Έφτασες το όριο εγγράφων ({limit}) για το plan «{plan}».',
      js_limit_pages: 'Έφτασες το όριο σελίδων ({limit}) για το plan «{plan}».',
      err_gemini_key: 'Δεν έχει οριστεί κλειδί Gemini API. Ρυθμίσεις → API Keys για να το καταχωρίσεις.',
      demo_key_desc: 'Δεν έχεις ακόμα Gemini API key; Δοκίμασε το FastWrite ΑΜΕΣΩΣ με τα δωρεάν έγγραφά σου — δεν χρειάζεται καμία ρύθμιση.',
      demo_key_btn: '🎁 Ενεργοποίηση δωρεάν εγγράφων',
      demo_key_ok: 'Ενεργοποιήθηκε! Μπορείς να επεξεργαστείς έως {cap} έγγραφα δωρεάν.',
      demo_chip_label: 'Δωρεάν',
      demo_remaining: '🎁 Δωρεάν έγγραφα: απομένουν {remaining} από {cap}. Όταν τελειώσουν, βάλε το δικό σου Gemini API key για να συνεχίσεις.',
      err_demo_unavailable: 'Το demo key δεν είναι διαθέσιμο αυτή τη στιγμή. Βάλε το δικό σου Gemini API key.',
      err_demo_server: 'Ο FastWrite server δεν είναι προσβάσιμος. Έλεγξε τη σύνδεσή σου ή δοκίμασε αργότερα.',
      err_demo_rate_limited: 'Πολλά αιτήματα demo key. Δοκίμασε ξανά αύριο ή βάλε δικό σου κλειδί.',
      err_demo_limit: 'Εξαντλήθηκε το όριο του demo key. Βάλε το δικό σου Gemini API key στις Ρυθμίσεις → API Keys για να συνεχίσεις.',
      err_only_pdf: 'Μόνο αρχεία PDF γίνονται δεκτά.',
      err_no_file: 'Δεν βρέθηκε αρχείο.',
    ...
    en: {
      ...
      // ── In-app Feedback ──
      sidebar_feedback: 'Feedback & Ideas',
      fb_title: 'Feedback & Ideas',
      fb_subtitle: 'Tell me what works, what does not, what is missing. Every message is read.',
      fb_category: 'Category',
      fb_cat_bug: 'Problem / Bug',
      fb_cat_idea: 'Idea / Suggestion',
      fb_cat_other: 'Other',
      fb_message: 'Message',
      fb_image: 'Screenshot (optional, PNG/JPG up to 2MB)',
      fb_privacy_note: '⚠ Do not attach images containing real invoices or personal data.',
      fb_cancel: 'Cancel',
      fb_send: 'Send',
      fb_sent: 'Message sent — thank you!',
      fb_err_message_required: 'Write a message first.',
      fb_err_image_type: 'Only PNG or JPG images.',
      fb_err_image_size: 'The image exceeds 2MB.',
      fb_err_image_read: 'Failed to read the image.',
      fb_err_send_failed: 'Sending failed. Please try again.',

      // ── Admin: Desktop Testers & Feedback ──
      admin_installs_title: 'Desktop Testers — Installs & Usage',
      admin_installs_note: 'Data from desktop telemetry pings (counts only — never document content).',
      admin_installs_empty: 'No installs yet.',
      admin_col_user: 'User',
      admin_col_registered: 'Registered',
      admin_col_demo_docs: 'Demo docs',
      admin_col_docs_total: 'Total docs',
      admin_col_last_seen: 'Last activity',
      admin_feedback_title: 'In-app Feedback',
      admin_feedback_empty: 'No feedback yet.',
      admin_feedback_image: 'Image ↗',
      ...
      docs_delete_title: 'Delete selected',
      le_docs_dd_hint: 'Show list of selected documents to edit',
      le_docs_btn: '📄 Documents',
      le_labels_dd_hint: 'Show existing labels — select or delete',
      le_sidebar_toggle_title: 'Show/Hide menu',
      le_lineitems_hint: 'Add a line-items table to the label — for invoices with many lines',
      le_hide_panel_title: 'Hide panel',
      le_label_name: 'Label Name',
      le_name_placeholder: 'e.g. invoice_dei, cosmote_receipt...',
      le_supplier: '🏢 Supplier / Vendor',
      le_supplier_placeholder: 'e.g. cosmote, ote — multiple, comma-separated',
      le_fields: 'Fields (comma-separated)',
      le_fields_placeholder: 'e.g. invoice_number, date, total',
      le_lineitems_cols: '📋 Line Items Columns (comma-separated)',
      le_lineitems_placeholder: 'e.g. Description, Quantity, Price',
      le_preview_hint: 'Preview the label structure before saving',
      le_preview_btn: 'Preview',
      le_preview_title: 'Label Preview',
      le_back_form_hint: 'Back to the form to make changes',
      le_save_hint: 'Save label — it will be available for auto-matching',
      le_save_btn: '💾 Save',
      tb_new_tmpl_title: '+ Create New Template',
      tb_name_placeholder: 'e.g. invoice, receipt',
      tb_addfield_hint: 'Add a new extraction field to the template',
      tb_addfield_btn: '+ Add Field',
      tb_save_btn: 'Save Template',
      doc_modal_title: 'Document Details',
      tmpl_modal_title: 'New Label',
      tmpl_label: 'Label',
      tmpl_name_placeholder: 'e.g. invoice_dei, cosmote_receipt...',
      tmpl_supplier: '🏢 Supplier / Vendor (supplier keywords, e.g. ΔΕΗ, DEI)',
      tmpl_supplier_placeholder: 'e.g. cosmote, ote — multiple, comma-separated',
      tmpl_addfield_hint: 'Add a new extraction field to the label',
      tmpl_addfield_btn: '+ Add Field',
      tmpl_paste_hint: 'Paste label from clipboard',
      tmpl_paste_btn: '📋 Paste',
      tmpl_save_hint: 'Save label — available for auto-matching documents',
      tmpl_save_btn: 'Save Template',
      precheck_modal_title: 'File Analysis',
      xero_oauth_timeout: 'OAuth timeout — try again',
      xero_connect_success: 'Successfully connected to Xero!',
      xero_error_toast: 'Xero error',
      xero_disconnect_confirm: 'Are you sure you want to disconnect from Xero?',
      xero_disconnected: 'Disconnected from Xero',
      xero_tenant_changed: 'Active tenant changed',
      xero_connect_first: 'You must first connect to Xero (Settings)',
      xero_select_account: 'Select an account code first',
      xero_push_failed: 'Push failed',
      xero_push_success: 'Bill created in Xero (DRAFT) — open with 🔗✓',
      xero_push_network_error: 'Network error during Push',
      license_invalid: 'Invalid license',
      license_error_label: 'License error',
      ...
      docs_th_file: 'FILE',
      docs_th_labels: 'Label',
      docs_th_supplier: 'Supplier Name',
      docs_th_buyer: 'Buyer Name',
      docs_last_n_label: 'Last',
      docs_last_n_btn: 'Select',
      docs_selected_lbl: 'Selected',
      docs_in_list_lbl: 'In list',
      ...
      js_batch_blocked_msg: 'Batch cannot run: {n} of the selected documents are ALREADY processed. Deselect them and try again.',
      js_batch_max_msg: 'The maximum is {max} invoices per Batch. You selected {n}. Reduce your selection and try again.',
      js_enter_valid_number: 'Enter a valid number',
      tpl_del_selected: 'Delete selected',
      tpl_del_all: 'Delete ALL',
      tpl_select_all: 'Select ALL',
      tpl_del_all_confirm: 'Delete ALL {n} labels? This cannot be undone.',
      ...
      js_limit_docs: 'You have reached the document limit ({limit}) for the "{plan}" plan.',
      js_limit_pages: 'You have reached the page limit ({limit}) for the "{plan}" plan.',
      err_gemini_key: 'No Gemini API key set. Go to Settings → API Keys to add it.',
      demo_key_desc: 'No Gemini API key yet? Try FastWrite right now with your free documents — no setup needed.',
      demo_key_btn: '🎁 Activate free documents',
      demo_key_ok: 'Activated! You can process up to {cap} documents for free.',
      demo_chip_label: 'Free',
      demo_remaining: '🎁 Free documents: {remaining} of {cap} left. When they run out, add your own Gemini API key to continue.',
      err_demo_unavailable: 'The demo key is not available right now. Please add your own Gemini API key.',
      err_demo_server: 'The FastWrite server is unreachable. Check your connection or try again later.',
      err_demo_rate_limited: 'Too many demo key requests. Try again tomorrow or add your own key.',
      err_demo_limit: 'Demo key limit reached. Add your own Gemini API key in Settings → API Keys to continue.',
      err_only_pdf: 'Only PDF files are accepted.',
      err_no_file: 'No file found.',

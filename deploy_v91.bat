...
echo.
echo  v91 = "ENIMEROTHIKE . v91" XORIS DEFTERI GRAMMI + KLEINEI STI LIPSI
echo.
...
if errorlevel 1 goto nm
findstr /c:"KM-UPD-SHUTTER" site\kostometro\app.js >nul
if errorlevel 1 goto nm
findstr /c:"upd-x" site\kostometro\index.html >nul
if errorlevel 1 goto nm
findstr /c:"\"v\": \"v91\"" site\kostometro\version.json >nul
if errorlevel 1 goto nm
findstr /c:"v91" site\kostometro\app.js >nul
if errorlevel 1 goto nm
...
if errorlevel 1 goto failed
git add deploy_v91.bat commit_v91.txt
if errorlevel 1 goto failed
git commit -F commit_v91.txt
if errorlevel 1 goto failed
...
echo   1) Anoixe to Kostometro - stin kamera: "Enimerothike . v91" xoris defteri grammi
...
exit /b 1
:lo
echo    Epezise PALIOS deiktis (km-v90, xanapliktrologei, pk-v4, source link, AIza).
goto failed
:nm

...
echo.
echo  v82 = TO MINYMA TOU 429 KAI TOU TypeError STIS RYTHMISEIS
echo.
echo        22/9 21:21 "TypeError" xoris minyma - 21:26 "anamoni oriou" xoris
echo        na xeroume an to orio einai ana lepto i ana imera.
echo        Kai: sto 429 dokimazetai to EPOMENO montelo (ta oria einai ana montelo).
echo.
...
if errorlevel 1 goto nm
findstr /c:"v82" site\kostometro\app.js >nul
if errorlevel 1 goto nm
echo    OK - 16 deiktes.
...
echo [4/5] Souites + 91 apodeixeis metallaxis, MIA TI FORA...
...
if errorlevel 1 goto failed
git add deploy_v82.bat commit_v82.txt
if errorlevel 1 goto failed
git commit -F commit_v82.txt
if errorlevel 1 goto failed
...
echo   1) Anoixe to Kostometro, Menou kato: v82
...
exit /b 1
:lo
echo    Epezise PALIOS deiktis (km-v81, v81, 30000, palio generationConfig i sw.js xoris ekdosi).
goto failed
:nm
